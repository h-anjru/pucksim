...
%   To omit lidar calibration pattern, enter calib_speed of zero.
    ...
    if calib_speed ~= 0
        ...
        calib(2, :) = calib(1, :) + calib_length * [sind(turn) cosd(turn)];
        calib(3, :) = calib(1, :) + calib_length * [sind(dir1) cosd(dir1)];
        calib(4, :) = calib(2, :) + calib_length * [sind(dir1) cosd(dir1)];
        calib(5, :) = calib(1, :);
        calib(6, :) = calib(4, :);
        calib(7, :) = calib(3, :);
        calib(8, :) = calib(2, :);
    ...
    all_spd = [
        home_speed; calib_speed * ones(size(calib, 1), 1); ...
